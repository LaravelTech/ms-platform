  ...
  <div class="login-box">
    ...
    <div class="card">
      <div class="card-body login-card-body">
        <p class="login-box-msg">{{ __('authenticate::login.title') }}</p>
        <form action="{{ route('authenticate.post-login') }}" method="POST">
          @csrf
          ...
          <div class="row">
            <div class="col-8">
              <div class="icheck-primary">
                ...
                <label for="remember">
                  {{ __('authenticate::login.remember') }}
                </label>
              </div>
            </div>
            <!-- /.col -->
            <div class="col-4">
              <button type="submit" class="btn btn-primary btn-block btn-flat">{{ __('authenticate::login.btn_signin') }}</button>
            </div>
            <!-- /.col -->
          </div>
        </form>
